...
<h1>Ejemplo de rutas en laravel</h1>
<h2><a href="{{ asset('demo1') }}"> Primer enlace </a></h2>
<h2><a href="{{ asset('solo_texto') }}"> Segundo enlace </a></h2>
<h2><a href="{{ asset('solo_texto2/John') }}"> Tercer enlace </a></h2>
<h2><a href="{{ asset('demo2/John/Perez') }}"> Cuarto enlace </a></h2>
<h2><a href="{{ asset('usar_controller') }}"> Quinto enlace </a></h2>
<h2><a href="{{ asset('usar_controller_y_param/John') }}"> Sexto enlace </a></h2>
@endsection()